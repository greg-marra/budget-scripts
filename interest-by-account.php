<?php
    ...
    # Get account Balance
    $endpoint = "/$BUDGET_ID/accounts/$DDC_401";
    curl_setopt($ch, CURLOPT_URL, $base . $endpoint);

    $acct = json_decode(curl_exec($ch), true);
    $total_balance = $acct["data"]["account"]["balance"] / 1000;

    # Endpoint to grab all transactions
    $endpoint = "/$BUDGET_ID/accounts/$DDC_401/transactions";
    curl_setopt($ch, CURLOPT_URL, $base . $endpoint);
    ...
    interest_analysis($yearly_totals, $total_balance, $report_name);
